...
public class Main {
	...
	public static void main(String[] args) throws ServiceException, RemoteException {
		...
		String sCepOrigem = "59910000"; //teclado.nextLine(); //"01310909";
		String sCepDestino = "59900000";//teclado.nextLine(); //"59856000";
		String nVlPeso = "5,5";//teclado.nextLine(); //"5,5";
		int nCdFormato = 1;//teclado.nextInt(); //1; //1 caixa/pacote | 2 rolo/prisma | 3 envelope
		BigDecimal nVlComprimento = new BigDecimal(16.0); // teclado.nextBigDecimal(); //new BigDecimal(16.0);
		BigDecimal nVlAltura = new BigDecimal(20.0);// teclado.nextBigDecimal(); //new BigDecimal(20.0);
		BigDecimal nVlLargura = new BigDecimal(20.0); //teclado.nextBigDecimal(); //new BigDecimal(20.0);
		...
		BigDecimal nVlValorDeclarado = new BigDecimal(0); //teclado.nextBigDecimal(); //new BigDecimal(0);
